...
python3 train.py gpus='0' backbone="CSPDarknet-s" num_epochs=300 exp_id="facect_CSPDarknet-s_640x640" use_amp=True val_intervals=2 data_num_workers=6 batch_size=52
#python3 train.py gpus='0' backbone="CSPDarknet-l" num_epochs=300 exp_id="facect_CSPDarknet-l_640x640" use_amp=True val_intervals=2 data_num_workers=6 batch_size=24  load_model="./exp/facect_CSPDarknet-l_640x640/model_last.pth" resume=True
