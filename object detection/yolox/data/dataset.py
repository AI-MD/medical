...
class COCODataset(torch.utils.data.Dataset):
    ...
    def __init__(self, cfg, img_size=(640, 640), name="train", json_file="instances_train2017.json", preproc=None,
...
class DICOMDataset(torch.utils.data.Dataset):
    ...
    def pull_item(self, index):
        ...
        return pixel_array, res.copy(), img_info, id_
...
def get_dataloader(opt, no_aug=False, logger=None, val_loader=True):
    ...
    # train
    train_dataset = DICOMDataset(opt,
