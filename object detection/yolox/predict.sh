...
python3 predict.py gpus='0' backbone="CSPDarknet-s" vis_thresh=0.3 load_model="exp/facect_CSPDarknet-s_640x640/model_best.pth" img_dir='./data/dataset/facial_bone_fracture_ct_dataset/images/val/'
