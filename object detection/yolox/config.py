...
opt.exp_id = "facect_CSPDarknet-s_640x640"  # experiment name, you can change it to any other name
opt.dataset_path = "./data/dataset/facial_ct_dataset"  # COCO detection
...
# coco 80 classes
opt.label_name = ['flexure', 'fracture']
