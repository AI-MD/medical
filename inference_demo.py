...
def cls_inference(config, logger):
    ...
    class_names= ["0_esophagus", "1_gastric", "2_small_bowel", "3_colon"]
    temp_path = "./duk_pillcam_test_512_1217_all"


    filename = "pillcam_test_duk_pillcam_test_512_1217_softmax.csv"
