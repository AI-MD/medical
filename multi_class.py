...
from common.model import StandardModel
...
def main(args: argparse.Namespace):
    ...
    model = StandardModel(args.num_classes)
    ...
    print("best_accuracy = {:6.2f}".format(best_acc))
    ...
    with torch.no_grad():
        ...
        for i, (data, target) in enumerate(val_loader):
            ...
            if outputs is not None:
                outputs.append(output.softmax(dim=1)) 
        ...
        if use_metric:
            ...
            levels = F.one_hot(targets, args.num_classes)            
            ...
            auc = roc_auc_score(levels, outputs, multi_class='ovr')
            print(' *AUC {auc:.4f}'.format(auc=auc))
